    ...
    public int process(List<Update> updates) {
        updates.forEach(update -> {
            ...
            if (update.message().text().equals("/start")) {
                SendMessage message = new SendMessage(chatId, String.format("Привет, %s! Введи задачу в формате 01.12.2023 12:12 поздравить с ДР", update.message().from().firstName()));
